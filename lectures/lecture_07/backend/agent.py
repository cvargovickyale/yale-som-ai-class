"""Yale SOM course assistant agent: pydantic-ai over search_courses (local)
...
# Loaded here (not just in main.py) because main.py imports this module
# before it calls load_dotenv, so PORTKEY_API_KEY must already be in the
# environment by the time this module builds the OpenAI client below.
load_dotenv(ROOT / ".env")
load_dotenv(ROOT.parent / ".env")
load_dotenv(ROOT.parent.parent / ".env")  # this workspace's actual root .env
